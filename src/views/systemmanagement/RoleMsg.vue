<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table ref="multipleTable" :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row style="width: 100%" @selection-change="selsChange">
      ...
      <el-table-column  v-if='true' prop="addTime" align="center" label="创建时间">
      </el-table-column>

      <el-table-column class-name="status-col" prop="status" label="角色状态">
      </el-table-column>
      ...
      <el-table-column align="center" label="操作" width="255">
        <template slot-scope="scope">
          ...
          <el-button v-if="true" size="small" type="success" @click="handleModifyStatus(scope.row,'deleted')">赋予权限
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form class="small-space" :model="temp" label-position="left" label-width="70px" style='width: 400px; margin-left:50px;'>
        ...
        <el-form-item label="创建时间">
          <!--<el-input v-model="temp.addTime" type = 'Date' placeholder="请输入内容"></el-input>-->
          <el-date-picker
