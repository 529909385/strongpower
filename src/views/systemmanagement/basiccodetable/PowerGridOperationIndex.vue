<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table ref="multipleTable" :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row style="width: 100%" @selection-change="selsChange">
      ...
      <el-table-column type="expand">
        <template scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            ...
            <el-form-item label="容载比">
              <span>{{ props.row.author }}</span>
            </el-form-item>
            <el-form-item label="单线或单变站座数">
              <span>{{ props.row.author }}</span>
            </el-form-item>
            <el-form-item label="单线或单变站比例">
              <span>{{ props.row.author }}</span>
            </el-form-item>
            <el-form-item label="满足N-1主变台数	">
              <span>{{ props.row.author }}</span>
            </el-form-item>
            <el-form-item label="满足N-1主变比例">
              <span>{{ props.row.author }}</span>
            </el-form-item>
            <el-form-item label="满足N-1线路条数">
              <span>{{ props.row.author }}</span>
            </el-form-item>
            <el-form-item label="满足N-1线路比例">
              <span>{{ props.row.author }}</span>
            </el-form-item>
          </el-form>
        </template>
      ...
      <el-table-column  v-if='true' prop="sort" align="center" label="电压等级">
      </el-table-column>

      <el-table-column  align="center" prop="title" label="容载比">
      </el-table-column>

      <el-table-column  align="center" prop="title" label="单线或单变站座数	">
      </el-table-column>

      <el-table-column  align="center" prop="title" label="单线或单变站比例">
      </el-table-column>

      <el-table-column  align="center" prop="title" label="满足N-1主变台数">
      </el-table-column>

      <el-table-column  align="center" prop="title" label="满足N-1主变比例">
      </el-table-column>

      <el-table-column  align="center" prop="title" label="满足N-1线路条数">
      </el-table-column>

      <el-table-column  align="center" prop="title" label="满足N-1线路比例">
      </el-table-column>
