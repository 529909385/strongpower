<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table ref="multipleTable" :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row style="width: 100%" @selection-change="selsChange">
      ...
      <el-table-column type="expand">
        <template scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            ...
            <el-form-item label="低压线路类型">
              <span>{{ props.row.sort }}</span>
            </el-form-item>
            <el-form-item label="导线截面1">
              <span>{{ props.row.author }}</span>
            </el-form-item>
            <el-form-item label="导线截面1长度">
              <span>{{ props.row.author }}</span>
            </el-form-item>
            <el-form-item label="导线截面2">
              <span>{{ props.row.author }}</span>
            </el-form-item>
            <el-form-item label="导线截面2长度">
              <span>{{ props.row.author }}</span>
            </el-form-item>
            <el-form-item label="导线截面3">
              <span>{{ props.row.author }}</span>
            </el-form-item>
            <el-form-item label="导线截面3长度">
              <span>{{ props.row.author }}</span>
            </el-form-item>
          </el-form>
        </template>
      ...
      <el-table-column  prop="title" align="center" label="低压线路类型">
      </el-table-column>

      <el-table-column  prop="title" align="center" label="导线截面1">
      </el-table-column>

      <el-table-column  prop="title" align="center" label="导线截面1长度">
      </el-table-column>

      <el-table-column  prop="title" align="center" label="导线截面2">
      </el-table-column>

      <el-table-column  prop="title" align="center" label="导线截面2长度">
      </el-table-column>

      <el-table-column  prop="title" align="center" label="导线截面3">
      </el-table-column>

      <el-table-column  prop="title" align="center" label="导线截面3长度">
      </el-table-column>
