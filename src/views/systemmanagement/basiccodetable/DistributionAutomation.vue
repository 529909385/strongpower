<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table ref="multipleTable" :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row style="width: 100%" @selection-change="selsChange">
      ...
      <el-table-column type="expand">
        <template scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            ...
            <el-form-item label="配电终端一遥比例(%)">
              <span>{{ props.row.author }}</span>
            </el-form-item>
            <el-form-item label="配电终端二遥比例(%)">
              <span>{{ props.row.author }}</span>
            </el-form-item>
            <el-form-item label="配电终端三遥比例(%)">
              <span>{{ props.row.author }}</span>
            </el-form-item>
          </el-form>
        </template>
      ...
      <el-table-column  align="center" prop="title" label="自动化覆盖率(%)">
      </el-table-column>

      <el-table-column  align="center" prop="title" label="配电终端一遥比例(%)">
      </el-table-column>

      <el-table-column  align="center" prop="title" label="配电终端二遥比例(%)">
      </el-table-column>

      <el-table-column  align="center" prop="title" label="配电终端三遥比例(%)">
      </el-table-column>
